            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="../../controllers/acoes-mouses.php" method="POST">
                        ...
                        <div class="row"> <!--Linha Nome-->
                            ...
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-select bg-dark text-white" name="conexaomou" aria-label="Armazenamento" text-uppercase required>
                        ...
                        <div class="mb-3">
                            <button type="submit" name="editar_mouse" class="btn btn-success float-end">
                                Salvar
                            </button>
                        </div>
                    </form>
