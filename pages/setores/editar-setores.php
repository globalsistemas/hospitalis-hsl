            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="../../controllers/acoes-setores.php" method="POST">
                        <input type="hidden" name="idset" value="<?= ($setor['idset']); ?>">
                        <div class="row"> <!--Linha Nome-->
                            ...
                            <div class="col-md-3">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" name="datcadastro" aria-label="Data Cadastro" class="form-control"  readonly
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="observacaoset" aria-label="observacao" class="form-control text-uppercase" value="<?= ($setor['observacaoset']); ?>">
                        </div>                        
                        <div class="mb-3">
                            <button type="submit" name="editar_setor" class="btn btn-success float-end">
                                Salvar
                            </button>
                        </div>
                    </form>
