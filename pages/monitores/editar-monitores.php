                ...
                <div class="card-body">
                    ...
                    <form action="../../controllers/acoes-monitores.php" method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="descricaomon" aria-label="Descricao" class="form-control text-uppercase" required 
                        ...
                        <div class="row"> <!--Linha Nome-->
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="polegadasmon" aria-label="Polegadas" class="form-control text-uppercase" 
                            ...
                            <div class="col-md-4">
                                <div class="input-group mb-3">
                                    ...
                                    <input type="date" name="datcadastrogmon" aria-label="Data Cadastro" class="form-control"  
                        ...
                        <div class="mb-3">
                            <button type="submit" name="editar_monitores" class="btn btn-success float-end">
                                Salvar
                            </button>
                        </div>
                    </form>
                    <?php 
                                ...
                                echo "<h5>MONITOR NÃO ENCONTRADO!</h5>";
                            }
                        }
                    ?>
                </div>
